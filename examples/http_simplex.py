...
def main():
    ...
    # 3. GET请求
    get_url = "https://112.31.84.164:8301/1024.txt"
    print(f"\nGET目标URL: {get_url}")
    ...
    # 4. POST请求
    post_url = "https://112.31.84.164:8301/upload.php"
    print(f"\nPOST目标URL: {post_url}")
    
    # 准备JSON数据
    post_data = {"url": "https://112.31.84.164:8301/upload.php"}
